...
$string['privacy:metadata:format_drip_email_log'] = 'Stores records of drip section email notifications sent to users.';
$string['privacy:metadata:format_drip_email_log:sectionid'] = 'The ID of the course section for which the email notification was sent.';
$string['privacy:metadata:format_drip_email_log:timecreated'] = 'The time the email notification was sent.';
$string['privacy:metadata:format_drip_email_log:userid'] = 'The ID of the user who received the email notification.';
